...
#Exercício 4
#select * from Animais where cor = 'branca' or cor = 'branco' and peso < 20;

#Exercício 5
#select nome, peso, cor from Animais where nome like 'B%';

#Exercício 6
#select nome, peso, cor from Animais where cor in ('vermelho', 'amarelo', 'marrom', 'laranja');

#Exercício 7
#select nome, nasc, peso, cor from Animais order by nasc desc;

#Exercício 8
#select * from Animais where nome like 'C%' and cor != 'branco' and cor != 'branca';
...
Exercício 12
select * from Animais where EXTRACT(MONTH from nasc) = 12 and EXTRACT(DAY from nasc) >= 22 or EXTRACT(MONTH from nasc) = 01 and EXTRACT(DAY from nasc) <= 19;
